...
const Canvas = ({ traceData, stepIndex, setStepIndex }) => {
  ...
  const categorizedVars = useMemo(() => {
    ...
    // 🔥 SMART DETECTION: Separate stacks and queues from regular arrays
    const smartArrays = {};
    const stacks = {};
    const queues = {};
    ...
    return categories;
  }, [currentVariables]); // Only recategorize when variables change

  // 🎯 VARIABLE STATE TRACKING (Memoized)
