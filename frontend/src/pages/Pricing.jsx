    ...
    <div className="min-h-full bg-bg text-text" style={FONT}>
      <div className="max-w-5xl mx-auto px-6 py-8 pb-16">
        ...
        <div className="text-center my-8">
          <span className="inline-flex items-center gap-2 text-[12px] font-semibold text-accent bg-accent/10 border border-accent/25 rounded-full px-3 py-1 mb-4"><Sparkles size={13} /> Simple pricing</span>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {plans.map((p) => {
              ...
              return (
                <div key={p.id} className={`flex flex-col bg-surface border rounded-2xl p-6 shadow-[var(--cz-shadow-sm)] ${highlight ? 'border-accent' : 'border-line'}`}>
