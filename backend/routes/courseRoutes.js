...
const { listCourses, getCourse, listCourseMeta, gradeQuiz, completeLesson, generateCourse, generateLessonVisual, setPublished, deleteCourse } = require('../controllers/courseController');
